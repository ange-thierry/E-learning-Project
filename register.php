...
<body>
    <div class="registration">
        <form method="post" action="">
            ...
            <div class="password-container">
                <input type="password" name="psw1" id="psw1" placeholder="Confirm password" required>
                <span class="toggle-password" onclick="togglePassword('psw1')">&#x1F441;</span>
            </div>
        ...
        if($_SERVER['REQUEST_METHOD']=="POST")
        {
            ...
            $sql="INSERT INTO abausers(Fullname,email,Password,Confirm) values('$fullname','$email','$password','$confirm')";
